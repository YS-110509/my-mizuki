...
export const siteConfig: SiteConfig = {
	...
	bilibili: {
		vmid: "1178950358", // 在此处设置你的Bilibili用户ID (vmid)，例如 "1129280784"
	...
	banner: {
		...
		src: {
			desktop: [
				"/assets/desktop-banner/pc01.jpg",
				"/assets/desktop-banner/pc02.jpg",
				"/assets/desktop-banner/pc03.jpg",
				"/assets/desktop-banner/pc04.jpg",
				"/assets/desktop-banner/pc05.jpg",
				"/assets/desktop-banner/pc06.jpg"
				], // 桌面横幅图片
			mobile: [
				"/assets/mobile-banner/pe01.jpg",
				"/assets/mobile-banner/pe02.jpg",
				"/assets/mobile-banner/pe03.jpg",
				"/assets/mobile-banner/pe04.jpg",
				"/assets/mobile-banner/pe05.jpg",
				"/assets/mobile-banner/pe06.jpg"
			], // 移动横幅图片
		}, // 使用本地横幅图片
	...
	links: [
		...
		// 支持自定义导航栏链接，支持多级菜单
		{
			...
			children: [
				...
				{
					name: "Bilibili",
					url: "https://space.bilibili.com/1178950358",
					external: true,
...
export const announcementConfig: AnnouncementConfig = {
	...
	content: "26年2月24日起本站暂时关闭音乐播放器功能；祝大家在芦花家玩得开心~", // 公告内容
